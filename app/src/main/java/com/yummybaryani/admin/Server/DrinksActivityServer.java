...
public class DrinksActivityServer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.drinks_screen);
        ...
        recyclerViewDrinks = findViewById(R.id.recycler_drink);
        recyclerViewDrinks.setHasFixedSize(true);
        recyclerViewDrinks.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false));
...
//                        startActivity(intent);
    ...
    private void addDrink() {
        Intent intent=new Intent(this,AddColdrinksActivity.class);
    ...
    private void updateDrink(final String key, final ColdDrink item) {
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(DrinksActivityServer.this, "Drink Updated", Toast.LENGTH_SHORT).show();
