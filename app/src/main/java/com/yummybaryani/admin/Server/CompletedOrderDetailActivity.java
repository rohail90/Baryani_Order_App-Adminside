...
public class CompletedOrderDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void sendEmail() {
        ...
        try {
            ...
            Toast.makeText(CompletedOrderDetailActivity.this, "There is no email client installed.", Toast.LENGTH_SHORT).show();
        }
    }
