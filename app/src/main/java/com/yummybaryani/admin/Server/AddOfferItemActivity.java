...
public class AddOfferItemActivity extends Activity implements View.OnClickListener {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    imageStorage.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            ourOffers.push().setValue(newFood);
                            Snackbar.make(foodName, "Offer added successfully", Snackbar.LENGTH_SHORT).show();
                            finish();
                            saveUri = null;
                        }
                    });
